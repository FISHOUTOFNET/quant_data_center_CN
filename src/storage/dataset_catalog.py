...
from src.quality.validators import (
    ...
    validate_akshare_cn_stock_yjyg_em,
...
AKSHARE_YJYG_EM_DATASET = DatasetDefinition(
    id="akshare_cn_stock_yjyg_em",
    logical_name="cn_stock_earnings_forecast",
    source="akshare",
    endpoint="stock_yjyg_em",
    code_format="six_digit",
    schema=AKSHARE_YJYG_EM_SCHEMA,
    validator=validate_akshare_cn_stock_yjyg_em,
    view_name="v_akshare_cn_stock_yjyg_em",
    partition_column="report_period",
    sort_columns=(
        "report_period",
        "code",
