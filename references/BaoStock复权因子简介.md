...
不复权，第0行，日期为2017-05-24，开盘价15.38，查找小于等于此日期（早于这个日期）的前复权因子（即2016-06-23的前复权因子）为0.759535，则前复权开盘价为：`15.38 * 0.759535 = 11.681648`；同样的收盘价、昨日收盘价也使用此计算。
...
不复权，第0行，日期为2017-05-24，开盘价15.38，查找小于等于此日期（早于这个日期）的后复权因子（即2016-06-23的后复权因子）为7.128788，则前复权开盘价为：`15.38 * 7.128788 = 109.64076`；同样的收盘价、昨日收盘价也使用此计算。
